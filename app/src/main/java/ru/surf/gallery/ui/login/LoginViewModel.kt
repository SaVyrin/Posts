            ...
            postDao.insertAll(
                listOf(
                    ...
                    Post(
                        ...
                        1655977750000.toDateFormat()
                    )
                )
            )
            for (userId in 1..1000) {
                val postsCount = (0..9).random()
